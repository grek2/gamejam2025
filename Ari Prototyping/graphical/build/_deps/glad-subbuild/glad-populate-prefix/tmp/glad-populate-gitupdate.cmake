...
execute_process(
  COMMAND "C:/Users/arisn/AppData/Local/Programs/Git/cmd/git.exe" --git-dir=.git show-ref "main"
  WORKING_DIRECTORY "C:/Programing/gamejam2025/Ari Prototyping/graphical/build/_deps/glad-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Programing/gamejam2025/Ari Prototyping/graphical/build/_deps/glad-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Programing/gamejam2025/Ari Prototyping/graphical/build/_deps/glad-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
